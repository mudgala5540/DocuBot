# llm_handler.py - FINAL, CORRECT VERSION
...
Synthesize a comprehensive, detailed answer using only the information from the context.
If the context is insufficient, state clearly: "Based on the provided documents, I could not find enough information to answer that question."
Crucially, identify every page number you used to formulate your answer from the [Source: Page X] tags.
